...
type ActuatorsPosition struct {
	...
	Angular ActuatorsAngularPosition `yaml:"angular"`// Position of the actuators in [rad]
	Linear ActuatorsLinearPosition `yaml:"linear"`// Position of the actuators in [m]
}
