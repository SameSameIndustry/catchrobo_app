...
type ActuatorsVelocity struct {
	...
	Angular ActuatorsAngularVelocity `yaml:"angular"`// Velocity of the actuators in [rad/s]
	Linear ActuatorsLinearVelocity `yaml:"linear"`// Velocity of the actuators in [m/s]
}
