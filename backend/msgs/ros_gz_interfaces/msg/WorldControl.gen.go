...
type WorldControl struct {
	Pause bool `yaml:"pause"`// Paused state.
	Step bool `yaml:"step"`
	MultiStep uint32 `yaml:"multi_step"`// Paused after stepping multi_step.
	Reset WorldReset `yaml:"reset"`
	Seed uint32 `yaml:"seed"`
	RunToSimTime builtin_interfaces_msg.Time `yaml:"run_to_sim_time"`// A simulation time in the future to run to and
}
