...
type GPSFix struct {
	Header std_msgs_msg.Header `yaml:"header"`// A more complete GPS fix to supplement sensor_msgs/NavSatFix.
	Status GPSStatus `yaml:"status"`
	Latitude float64 `yaml:"latitude"`// Latitude (degrees). Positive is north of equator; negative is south.
	Longitude float64 `yaml:"longitude"`// Longitude (degrees). Positive is east of prime meridian, negative west.
	Altitude float64 `yaml:"altitude"`// Altitude (meters). Positive is above reference (e.g., sea level).
	Track float64 `yaml:"track"`// Direction (degrees from north)
	Speed float64 `yaml:"speed"`// Ground speed (meters/second)
	Climb float64 `yaml:"climb"`// Vertical speed (meters/second)
	Pitch float64 `yaml:"pitch"`// Device orientation (units in degrees)
	Roll float64 `yaml:"roll"`
	Dip float64 `yaml:"dip"`
	Time float64 `yaml:"time"`// GPS time
	Gdop float64 `yaml:"gdop"`// Total (positional-temporal) dilution of precision
	Pdop float64 `yaml:"pdop"`// Positional (3D) dilution of precision
	Hdop float64 `yaml:"hdop"`// Horizontal dilution of precision
	Vdop float64 `yaml:"vdop"`// Vertical dilution of precision
	Tdop float64 `yaml:"tdop"`// Temporal dilution of precision
	Err float64 `yaml:"err"`// Spherical position uncertainty (meters) [epe]
	ErrHorz float64 `yaml:"err_horz"`// Horizontal position uncertainty (meters) [eph]
	ErrVert float64 `yaml:"err_vert"`// Vertical position uncertainty (meters) [epv]
	ErrTrack float64 `yaml:"err_track"`// Track uncertainty (degrees) [epd]
	ErrSpeed float64 `yaml:"err_speed"`// Ground speed uncertainty (meters/second) [eps]
	ErrClimb float64 `yaml:"err_climb"`// Vertical speed uncertainty (meters/second) [epc]
	ErrTime float64 `yaml:"err_time"`// Temporal uncertainty [ept]
	ErrPitch float64 `yaml:"err_pitch"`// Orientation uncertainty (degrees)
	ErrRoll float64 `yaml:"err_roll"`
	ErrDip float64 `yaml:"err_dip"`
