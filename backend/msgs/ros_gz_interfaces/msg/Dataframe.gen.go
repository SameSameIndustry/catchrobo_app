...
type Dataframe struct {
	Header std_msgs_msg.Header `yaml:"header"`// Time stamp. Message containing some payload as well as sender and destinationIntended for use with the comms system in Gazebo
	SrcAddress string `yaml:"src_address"`// Address of the sender
	DstAddress string `yaml:"dst_address"`// Address of the destination
	Data []uint8 `yaml:"data"`// Payload
	Rssi float64 `yaml:"rssi"`// Received Signal Strength Indicator
}
