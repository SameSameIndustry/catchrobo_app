...
type Altimeter struct {
	...
	VerticalPosition float64 `yaml:"vertical_position"`// Vertical position data, in meters.
	VerticalVelocity float64 `yaml:"vertical_velocity"`// Vertical velocity data, in meters/second.
	VerticalReference float64 `yaml:"vertical_reference"`// Vertical reference.
}
