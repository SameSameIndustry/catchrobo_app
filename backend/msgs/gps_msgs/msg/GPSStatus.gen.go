...
const (
	...
	GPSStatus_STATUS_RTK_FIX int16 = 19// Real-Time Kinematic, fixed integers
	GPSStatus_STATUS_RTK_FLOAT int16 = 20// Real-Time Kinematic, float integers
...
type GPSStatus struct {
	...
	SatellitesUsed uint16 `yaml:"satellites_used"`// Number of satellites. Satellites used in solution
	SatelliteUsedPrn []int32 `yaml:"satellite_used_prn"`// PRN identifiers
	SatellitesVisible uint16 `yaml:"satellites_visible"`// Satellites visible
	SatelliteVisiblePrn []int32 `yaml:"satellite_visible_prn"`// PRN identifiers
	SatelliteVisibleZ []int32 `yaml:"satellite_visible_z"`// Elevation of satellites
	SatelliteVisibleAzimuth []int32 `yaml:"satellite_visible_azimuth"`// Azimuth of satellites
	SatelliteVisibleSnr []int32 `yaml:"satellite_visible_snr"`// Signal-to-noise ratios (dB)
	Status int16 `yaml:"status"`
	MotionSource uint16 `yaml:"motion_source"`// Source for speed, climb and track
	OrientationSource uint16 `yaml:"orientation_source"`// Source for device orientation
	PositionSource uint16 `yaml:"position_source"`// Source for position
}
