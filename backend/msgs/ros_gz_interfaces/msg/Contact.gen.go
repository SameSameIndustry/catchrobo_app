...
type Contact struct {
	Collision1 Entity `yaml:"collision1"`// Contact collision1
	Collision2 Entity `yaml:"collision2"`// Contact collision2
	Positions []geometry_msgs_msg.Vector3 `yaml:"positions"`// List of contact position
	Normals []geometry_msgs_msg.Vector3 `yaml:"normals"`// List of contact normals
	Depths []float64 `yaml:"depths"`// List of penetration depths
	Wrenches []JointWrench `yaml:"wrenches"`// List of joint wrenches including forces/torques
}
