...
import (
	...
	ros_gz_interfaces_msg "msgs/ros_gz_interfaces/msg"
...
type SetEntityPose_Request struct {
	Entity ros_gz_interfaces_msg.Entity `yaml:"entity"`// Gazebo Sim entity.
	Pose geometry_msgs_msg.Pose `yaml:"pose"`// Pose of entity.
}
