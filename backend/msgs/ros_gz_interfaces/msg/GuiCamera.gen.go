...
type GuiCamera struct {
	...
	ViewController string `yaml:"view_controller"`
	Pose geometry_msgs_msg.Pose `yaml:"pose"`
	Track TrackVisual `yaml:"track"`
	ProjectionType string `yaml:"projection_type"`// Type of projection: "perspective" or "orthographic".
}
