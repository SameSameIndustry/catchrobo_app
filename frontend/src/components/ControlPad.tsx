...
import { sendDisplacement,addDownMotion,addUpMotion, startMotion } from '../api/robotAPI';
    ...
    <div className="control-pad-container">
      ...
      <div className="control-pad-body">
        ...
        <div className="z-column">
          <button className="control-button z-up"   onMouseDown={() => addUpMotion()}>Z+</button>
          <button className="control-button z-down" onMouseDown={() => addDownMotion()}>Z-</button>
        </div>
      </div>
    </div>
  );
