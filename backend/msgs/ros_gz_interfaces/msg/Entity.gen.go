...
type Entity struct {
	Id uint64 `yaml:"id"`// Entity unique identifier across all types. Defaults to 0
	Name string `yaml:"name"`// Entity name, which is not guaranteed to be unique.
	Type uint8 `yaml:"type"`// Entity type.
}
