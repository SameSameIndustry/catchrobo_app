...
type VideoRecord struct {
	...
	Start bool `yaml:"start"`// True to start video recording.
	Stop bool `yaml:"stop"`// True to stop video recording.
	Format string `yaml:"format"`// Video encoding format, e.g. "mp4", "ogv".
	SaveFilename string `yaml:"save_filename"`// filename of the recorded video.
}
