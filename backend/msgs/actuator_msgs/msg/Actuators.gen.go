...
type Actuators struct {
	...
	Position []float64 `yaml:"position"`// Position of the actuators in [rad] for angular actuators
	Velocity []float64 `yaml:"velocity"`// Velocities of the actuators in [rad/s] for angular actuators
	Normalized []float64 `yaml:"normalized"`// Everything that does not fit the above,
}
