...
type JointWrench struct {
	Header std_msgs_msg.Header `yaml:"header"`// Time stamp
	Body1Name std_msgs_msg.String `yaml:"body_1_name"`// Body 1 name string
	Body1Id std_msgs_msg.UInt32 `yaml:"body_1_id"`// Body 1 id
	Body2Name std_msgs_msg.String `yaml:"body_2_name"`// Body 2 name string
	Body2Id std_msgs_msg.UInt32 `yaml:"body_2_id"`// Body 2 id
	Body1Wrench geometry_msgs_msg.Wrench `yaml:"body_1_wrench"`// Body 1 wrench
	Body2Wrench geometry_msgs_msg.Wrench `yaml:"body_2_wrench"`// Body 2 wrench
}
